...
class ShortcodesMenuPage extends AbstractMenuPage {
	...
	public function initShortcodes(){
		...
		$this->shortcodes[MPHB()->getShortcodes()->getAvailabilityCalendar()->getName()] = array(
			...
			'example'		 => array(
				'shortcode' => MPHB()->getShortcodes()->getAvailabilityCalendar()->generateShortcode( array(
					'id'			 => '999',
					'monthstoshow'	 => '2,3'
				) ),
		...
		$this->shortcodes[MPHB()->getShortcodes()->getSearchResults()->getName()] = array(
			...
			'parameters'	 => array(
				...
				'orderby'			 => array(
					...
					'values'	 => sprintf( __( '%1$s. See the <a href="%2$s" target="_blank">full list</a>.', 'motopress-hotel-booking' ),
