...
class BookingConfirmationShortcode extends AbstractShortcode
{
    ...
    public function detectBookingConfirmationStatus()
    {
        ...
        $status = sanitize_text_field($_GET['mphb_confirmation_status']);
    ...
    public function detectPaymentConfirmationStatus()
    {
        ...
        $status = sanitize_text_field($_GET['mphb_payment_status']);
        ...
        <div class="mphb-booking-details-section booking">
            ...
            <ul class="mphb-booking-details">
                ...
                <li class="booking-check-in">
                    ...
                    <span class="value"><?php echo esc_html( DateUtils::formatDateWPFront($booking->getCheckInDate()) ); ?></span>
                </li>
                <li class="booking-check-out">
                    <span class="label"><?php _e('Check-out:', 'motopress-hotel-booking'); ?></span>
                    <span class="value"><?php echo esc_html( DateUtils::formatDateWPFront($booking->getCheckOutDate()) ); ?></span>
                </li>
    ...
    public function renderPaymentDetails($payment)
    {
        ...
        <div class="mphb-booking-details-section payment">
            <h3 class="mphb-booking-details-title"><?php _e('Payment Details', 'motopress-hotel-booking'); ?></h3>
            <ul class="mphb-booking-details">
                <li class="payment-number">
                    <span class="label"><?php _e('Payment:', 'motopress-hotel-booking'); ?></span>
                    <span class="value"><?php echo esc_html($payment->getId()); ?></span>
                </li>
                <li class="payment-number">
                    <span class="label"><?php _e('Date:', 'motopress-hotel-booking'); ?></span>
                    <span class="value"><?php echo esc_html(DateUtils::formatDateWPFront($payment->getDate())); ?></span>
                </li>
                <li class="payment-number">
                    <span class="label"><?php _e('Payment Method:', 'motopress-hotel-booking'); ?></span>
                    <span class="value"><?php echo esc_html($gatewayTitle); ?></span>
                </li>
                <li class="payment-number">
                    <span class="label"><?php _e('Total:', 'motopress-hotel-booking'); ?></span>
                    <span class="value"><?php echo mphb_format_price($payment->getAmount()); ?></span>
                </li>
                <li class="payment-number">
                    <span class="label"><?php _e('Status:', 'motopress-hotel-booking'); ?></span>
